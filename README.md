...
|---|---|---|
| 🤖 [Multi-Agent Text-to-SQL](https://github.com/tzjZhengJie/agentic-system-analyst) | Translates business questions into production-ready SQL using RAG-based schema retrieval and query validation | Python, LLM, RAG, OpenAI API |
...
| 📰 [Resume-to-Job Recommender](https://chriszj.com/hackathon) | Parses uploaded resumes using Gemini via Vertex AI API to extract skills and experience, then matches the output against a BERT-classified job database to surface relevant job recommendations | Python, NLP, Vertex AI |
